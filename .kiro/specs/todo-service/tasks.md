...
- [x] 3. バックエンド実装: タスク管理 (#14)
- [x] 3.1 タスク CRUD API の実装 (#14)
...
- [x] 5. フロントエンド実装: ユーザープロファイル (#16)
- [x] 5.1 ユーザー設定 UI の実装 (#16)
...
- [x] 6. フロントエンド実装: Kanban ボード (#17)
- [x] 6.1 Kanban UI と DnD の実装 (#17)
